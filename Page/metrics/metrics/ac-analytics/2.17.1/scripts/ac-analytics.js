        ...
        !function() {
            ...
            window.AppMeasurement = function(e) {
                ...
                t.Nb = function() {
                    ...
                    a && !t.Ka && !/^[0-9.]+$/.test(a) && (i = 2 < (i = i ? parseInt(i) : 2) ? i : 2,
                    0 <= (e = a.lastIndexOf(".")))) {
                        for (; 0 <= e && 1 < i; )
                            e = a.lastIndexOf(".", e - 1),
                            i--;
                ...
                t.c_w = t.cookieWrite = function(e, n, a) {
                    var i, r = t.Nb(), o = t.cookieLifetime;
                    return n = "" + n,
                    o = o ? ("" + o).toUpperCase() : "",
                                    ...
                                    c) {
                                        if ("retrieveLightData" == i && 0 > r.indexOf(".contextData."))
                                            ...
                                            case "campaign":
                                                ...
                                                break;
                                            default:
                                                t.Ra(l) && ("prop" == s ? o = "c" + l : "eVar" == s ? o = "v" + l : "list" == s ? o = "l" + l : "hier" == s && (o = "h" + l,
                                                c = c.substring(0, 255)))
                                            }
                    ...
                    n = 0; n < e.length; n++) {
                        ...
                        o && (!f || 0 <= f.indexOf("," + r + ","))) {
                            ...
                            case "retrieveLightData":
                                ...
                                break;
                            default:
                                t.Ra(c) && ("prop" == i ? r = "c" + c : "eVar" == i ? r = "v" + c : "list" == i ? r = "l" + c : "hier" == i && (r = "h" + c,
                                o = o.substring(0, 255)))
                            }
                ...
                t.B = function(e) {
                    var t = e.tagName;
                    return "undefined" != "" + e.lc || "undefined" != "" + e.Zb && "HTML" != ("" + e.Zb).toUpperCase() ? "" : ("SHAPE" == (t = t && t.toUpperCase ? t.toUpperCase() : "") && (t = ""),
                ...
                t.L = function(e) {
                    ...
                    o = 3) : "IMAGE" == i && e.src && (r = e.src) : r = t.Na(e),
                    r) ? {
                ...
                t.Yb = function() {
                    ...
                    !c && s) {
                        ...
                        t.Qa(l) && (t.linkInternalFilters || (t.linkInternalFilters = n.location.hostname),
                        i = 0,
                ...
                t.Rb = function() {
                    ...
                    t.trackClickMap || t.trackInlineStats || t.Ub()) {
                        n = {},
                        a = 0;
                        var r, o, c, s = (l = t.rb()) ? l.split("&") : 0, l = 0;
                        if (s)
                ...
                t.isReadyToTrack = function() {
                    var e = !0;
                    return !(!t.ob() || !t.mb()) && (t.qb() || (e = !1),
                    t.tb() || (e = !1),
                    e)
                }
                ,
                t.ob = function() {
                    return t.ca || t.H || (t.eb(t.Cb) ? t.H = !0 : t.ca = !0),
                    !(t.ca && !t.H)
                }
                ,
                t.mb = function() {
                    ...
                    if (e) {
                        if (!t.ta && !t.ba)
                            return e.fetchPermissions(t.vb, !0),
                            t.ba = !0,
                            !1;
                        if (!t.ta)
                            return !1;
                ...
                ,
                t.tb = function() {
                    return t.aa || t.G || (t.cb(t.Aa) ? t.G = !0 : t.aa = !0),
                    !(t.aa && !t.G)
                }
                ,
                t.ba = !1,
                ...
                t.ua = function(e) {
                    ...
                    e != a)
                        for (n in e)
                            i[n] = e[n];
                    t.callbackWhenReadyToTrack(t, t.Fa, [i]),
                    t.Da()
                }
                ,
                t.Ob = function() {
                ...
                t.Fa = function(e) {
                    ...
                    t.T());
                    e && (a = t.S(e, 1)),
                    t.Vb() && !t.visitorOptedOut && (t.xa() || (t.fid = t.Ob()),
                    t.Yb(),
                    ...
                    t.referrer || t.$a || (e = t.Util.getQueryParam("adobe_mc_ref", null, null, !0),
                    ...
                    t.u("_g")),
                    t.Rb() && !t.abort && (s && t.V("TARGET") && !t.supplementalDataID && s.getSupplementalDataID && (t.supplementalDataID = s.getSupplementalDataID("AppMeasurement:" + t._in, !t.expectSupplementalData)),
                ...
                t.t = t.track = function(e, n) {
                    n && t.S(n),
                    t.Y = !0,
                    t.isReadyToTrack() ? null != t.j && 0 < t.j.length ? (t.ua(e),
                    t.p()) : t.Fa(e) : t.ua(e)
                }
                ,
                t.wb = function() {
                            ...
                            if ("string" == typeof a.c && "aa." == a.id.substr(0, 3))
                                for (var i = a.c.match(t.gc), r = 0; r < i.length; ++r) {
                                    var o = i[r]
                                      , c = o.match(t.Za)
                                      , s = "";
                                    "%" == c[1] && "timezone_offset" == c[2] ? s = (new Date).getTimezoneOffset() : "%" == c[1] && "timestampz" == c[2] && (s = t.Pb()),
                ...
                t.ra = function(e) {
                    t.Pa || (e || (e = 0),
                    t.Pa = setTimeout(t.U, e))
                }
                ,
                t.Fb = function() {
                    var e;
                    return !t.trackOffline || 0 >= t.offlineThrottleDelay ? 0 : (e = t.A() - t.Ua,
                ...
                t.$b = function(e) {
                    ...
                    !i && t.xa() && 2047 < e.length && (t.bb() && (r = 2,
                    i = new XMLHttpRequest),
                    i && (t.AudienceManagement && t.AudienceManagement.isReady() || 0 != t.usePostbacks) && (t.X ? i.Ha = !0 : i = 0)),
                ...
                t.nb = function(e) {
                    var n = !1;
                    return navigator.sendBeacon && (t.pb(e) ? n = !0 : t.useBeacon && (n = !0)),
                    t.yb(e) && (n = !1),
                    n
                }
                ,
                ...
                t.Xa = function() {
                    ...
                    ,
                    t.b && t.b.attachEvent ? t.b.attachEvent("onclick", t.r) : t.b && t.b.addEventListener && (navigator && (0 <= navigator.userAgent.indexOf("WebKit") && t.d.createEvent || 0 <= navigator.userAgent.indexOf("Firefox/2") && n.MouseEvent) && (t.Ia = 1,
                    t.useForcedLinkTracking = 1,
                    t.b.addEventListener("click", t.r, !0)),
                    t.b.addEventListener("click", t.r, !1))) : setTimeout(t.Xa, 30)
                }
                ,
                t.fc = t.ya(),
                t.Kb(),
                t.mc || (e ? t.setAccount(e) : t.C("Error, missing Report Suite ID in AppMeasurement initialization"),
                t.Xa(),
